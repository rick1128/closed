...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/rickthon")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/x7_cm90bot")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/rickthonteam")]])
